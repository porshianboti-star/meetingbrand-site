...
-- Generated from ../009-employees-insert-guard.sql by transform (do not hand-edit; edit the source and re-run).
-- ============================================================
-- ============================================================
...
create or replace function mb.guard_employee_insert()
...
begin
  ...
  select count(*) into v_csv_rows from mb.employees e where e.org_id = new.org_id and e.platform = 'csv';
...
drop trigger if exists employees_guard_insert on mb.employees;
create trigger employees_guard_insert
  before insert on mb.employees
  for each row execute function mb.guard_employee_insert();
